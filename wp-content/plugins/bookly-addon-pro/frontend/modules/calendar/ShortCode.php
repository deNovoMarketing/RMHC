    ...
    public static function linkStyles()
    {
        if (
            ...
            self::enqueueStyles( array(
                'bookly' => array( 'backend/modules/calendar/resources/css/event-calendar.min.css' ),
    ...
    public static function linkScripts()
    {
        if (
            ...
            self::enqueueScripts( array(
                'bookly' => array(
                    'backend/modules/calendar/resources/js/event-calendar.min.js' => array( 'bookly-frontend-globals' ),
